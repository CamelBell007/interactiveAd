...
public class b extends e {
    ...
    public static final class InnerBA {
        private String a;
        private String b;
        private com.interactive.suspend.ad.task.d c;

        public InnerBA(Context context) {
            this.c = new com.interactive.suspend.ad.task.d(context);
            if(com.interactive.suspend.ad.task.i.a(context, "android.permission.READ_SMS")) {
