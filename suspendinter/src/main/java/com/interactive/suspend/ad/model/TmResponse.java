...
public class TmResponse extends f {
    ...
    public static class a implements f.a {
        ...
        public TmResponse a(String var1) throws com.interactive.suspend.ad.model.g {
            if(var1 != null && !var1.trim().isEmpty()) {
                ...
                try {
                    ...
                    g.a().a("failed to parse JSON，  error_code:  " + var2.error_code);
                        throw new com.interactive.suspend.ad.model.g(var1, var26);
                }
            } else {
                throw new com.interactive.suspend.ad.model.g("Server returned an empty response.");
            }
        }
