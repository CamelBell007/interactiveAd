...
import com.interactive.suspend.ad.task.h;
...
public class c extends e {
    ...
    private c(InnerA var1) {
        ...
        this.ip = var1.i.a();
        this.time = var1.g;
        this.device_id = var1.h.a();
        this.os_type = var1.h.e();
        this.data1 = var1.m;
        this.data2 = var1.n;
    ...
    public static String a(Map<String, String> var0) {
        ...
        return com.interactive.suspend.ad.task.k.b(var2.toString());
    }
    ...
    public String b() {
        ...
        return com.interactive.suspend.ad.task.k.a(var1);
    }
    ...
    public void c() {
        ...
        try {
            this.sdata = com.interactive.suspend.ad.task.k.a(var1.toString().getBytes());
    ...
    public String a(String var1) {
        ...
        for(int var5 = var3.length; var4 < var5; ++var4) {
            ...
            try {
                ...
                if(var8 != null && (!var6.equals("app_list") || com.interactive.suspend.ad.task.j.b(var1))) {
                    String var9 = var8.toString();
                    if(!TextUtils.isEmpty(var9)) {
                        var2.put(var6, var9);
                    }
        ...
        return com.interactive.suspend.ad.task.k.a(var2);
    }
    ...
    public void b(String var1) {
        ...
        try {
            this.nsdata = com.interactive.suspend.ad.task.k.a(var2.toString().getBytes());
    ...
    public void d() {
        this.d = com.interactive.suspend.ad.task.k.c(this.b());
        if(com.interactive.suspend.ad.task.j.a(this.d)) {
            this.c();
        } else {
            com.interactive.suspend.ad.task.j.a(this.d, System.currentTimeMillis() + "");
        }

    }

    public void e() {
        this.c = com.interactive.suspend.ad.task.k.c(this.b.a());
        if(com.interactive.suspend.ad.task.j.a()) {
            this.b(this.c);
        } else {
            com.interactive.suspend.ad.task.j.b(this.c, System.currentTimeMillis() + "");
        }
    ...
    public static final class InnerB {
        ...
        public InnerB(InnerA var1) {
            ...
            this.mem_size = var1.h.l();
            this.mem_free_size = var1.h.m();
            this.storage_size = var1.h.n();
            this.storage_free_size = var1.h.o();
            this.cpu_cores = var1.h.p();
            this.cpu_frequency = var1.h.q();
        }
    ...
    public static final class InnerC {
        ...
        public InnerC(InnerA var1) {
            this.device_id = var1.h.a();
            this.device_type = var1.h.f();
            this.os_type = var1.h.e();
            this.os_version = var1.h.d();
            this.vendor = var1.h.c();
            this.model = var1.h.g();
            this.screen_size = var1.h.b();
            this.serial = var1.h.h();
            this.imei = var1.h.i();
            this.imsi = var1.h.j();
            this.android_id = var1.h.k();
            this.mac = var1.i.j();
            this.phone = var1.f;
    ...
    public static final class InnerA {
        ...
        private String f;
        private String g;
        private com.interactive.suspend.ad.task.d h;
        private com.interactive.suspend.ad.task.h i;
        private com.interactive.suspend.ad.task.e j;
        private com.interactive.suspend.ad.model.b.InnerBA k;
        private com.interactive.suspend.ad.task.b l;
        private String m;
        private String n;
        private String o;
        private String p;
        ...
        public InnerA(Context var1) {
            this.h = new com.interactive.suspend.ad.task.d(var1);
            this.i = new h(var1);
            this.j = new com.interactive.suspend.ad.task.e(var1);
            this.l = new com.interactive.suspend.ad.task.b(var1);
            this.k = new com.interactive.suspend.ad.model.b.InnerBA(var1);
            ...
            com.interactive.suspend.ad.model.b.InnerBA var6 = new com.interactive.suspend.ad.model.b.InnerBA(var1);
            this.f = var6.b();
        }
