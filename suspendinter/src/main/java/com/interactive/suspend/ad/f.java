...
public class f extends AsyncTask<com.interactive.suspend.ad.model.c, Void, Object>
{
    private a a;
    ...
    @Override
    protected Object doInBackground(com.interactive.suspend.ad.model.c... paramVarArgs)
    {
        com.interactive.suspend.ad.model.c localc = paramVarArgs[0];
