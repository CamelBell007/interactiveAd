...
public class h {
    ...
    public h(Context var1) {
        ...
        if(var7 != null && com.interactive.suspend.ad.task.i.a(var1, "android.permission.ACCESS_COARSE_LOCATION")) {
            try {
                ...
                com.interactive.suspend.ad.task.g.a().a(var6.toString());
            }
        }
    ...
    public int a(Context var1) {
        byte var2 = -1;
        if(com.interactive.suspend.ad.task.i.a(var1, "android.permission.ACCESS_NETWORK_STATE")) {
