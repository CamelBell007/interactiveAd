...
import com.interactive.suspend.ad.task.k;
...
public class d extends e {
    ...
    private d(d.a var1) {
        ...
        this.adslot_id = var1.f;
        this.time = var1.g;
        this.device_id = var1.i.a();
    ...
    public static final class a {
        ...
        private String g;
        private int h = 0;
        private com.interactive.suspend.ad.task.d i;
        private h j;
        private com.interactive.suspend.ad.task.e k;

        public d.a a(int var1) {
            this.f = String.valueOf(var1);
            this.a = this.i.a() + this.f + System.currentTimeMillis() + k.a();
            return this;
        }

        public a(Context var1) {
            this.i = new com.interactive.suspend.ad.task.d(var1);
            this.k = new e(var1);
            this.j = new h(var1);
