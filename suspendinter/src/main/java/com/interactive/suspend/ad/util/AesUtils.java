...
//        .fill(iv, (byte) 0x00); //fix No SuchMethodError: Ljava/util/Arrays ?
    ...
    public static String getEncryptBody(String body) {
        try {
            ...
            return URLEncoder.encode(dynamicKey + base64Encode(encrypt(body.getBytes(),
                    MD5Encode(dynamicKey + SALT_KEY, ""))), "UTF-8");
        } catch (Exception e) {
            return "";
        }
    }
